...
if __name__ == "__main__":
	...
	topology_1_pos_file = '%s.pos.top1000.topology.tsv' % topology_1_name
	topology_2_pos_file = '%s.pos.top1000.topology.tsv' % topology_2_name
	topology_3_pos_file = '%s.pos.top1000.topology.tsv' % topology_3_name
	
	topology_1_neg_file = '%s.neg.top1000.topology.tsv' % topology_1_name
	topology_2_neg_file = '%s.neg.top1000.topology.tsv' % topology_2_name
	topology_3_neg_file = '%s.neg.top1000.topology.tsv' % topology_3_name
