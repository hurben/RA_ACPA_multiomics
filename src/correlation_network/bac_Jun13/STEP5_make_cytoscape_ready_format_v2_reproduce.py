...
if __name__ == "__main__":
	...
	topology_1_file = '../topology_data_reproduce/%s.corr.pad.topology.tsv' % topology_name_list[0]
	topology_2_file = '../topology_data_reproduce/%s.corr.pad.topology.tsv' % topology_name_list[1]
	topology_3_file = '../topology_data_reproduce/%s.corr.pad.topology.tsv' % topology_name_list[2]
