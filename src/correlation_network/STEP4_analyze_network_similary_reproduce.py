...
if __name__ == "__main__":
	...
	topology_1_pos_file = '../topology_data_reproduce/%s.corr.pad.sig.pos.topology.tsv' % topology_1_name
	topology_2_pos_file = '../topology_data_reproduce/%s.corr.pad.sig.pos.topology.tsv' % topology_2_name
	topology_3_pos_file = '../topology_data_reproduce/%s.corr.pad.sig.pos.topology.tsv' % topology_3_name
	
	topology_1_neg_file = '../topology_data_reproduce/%s.corr.pad.sig.neg.topology.tsv' % topology_1_name
	topology_2_neg_file = '../topology_data_reproduce/%s.corr.pad.sig.neg.topology.tsv' % topology_2_name
	topology_3_neg_file = '../topology_data_reproduce/%s.corr.pad.sig.neg.topology.tsv' % topology_3_name
