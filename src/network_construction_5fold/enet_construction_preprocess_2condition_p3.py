...
#designed for metabolites+autoantibody only
#
...
if __name__ == "__main__":
	...
	omics_list = ["autoantibody","metabolites","patient_info"]
	...
	if step2 == 1:
		multiplex_dict, feature_list = CVP.merge_multiple_dict_main_p3(PI_dict, M_dict, AA_dict, PI_patient_list, PI_list, M_list, AA_list)
