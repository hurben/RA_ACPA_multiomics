...
#designed for metabolites+proteomics only
#
...
if __name__ == "__main__":
	...
	if step2 == 1:
		multiplex_dict, feature_list = CVP.merge_multiple_dict_main_p2(PI_dict, M_dict, P_dict, PI_patient_list, PI_list, M_list, P_list)
