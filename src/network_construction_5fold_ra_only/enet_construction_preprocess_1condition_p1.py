...
if __name__ == "__main__":
	...
	omics_list = ["proteomics", "patient_info"]
	...
	if step2 == 1:
		multiplex_dict, feature_list = CVP.merge_multiple_dict_main_c1p1(PI_dict, P_dict, PI_patient_list, PI_list, P_list)
