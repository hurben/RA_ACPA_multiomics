...
#designed for proteomics+autoantibody only
#
...
if __name__ == "__main__":
	...
	omics_list = ["proteomics", "autoantibody","patient_info"]
	...
	if step2 == 1:
		multiplex_dict, feature_list = CVP.merge_multiple_dict_main_p1(PI_dict, AA_dict, P_dict, PI_patient_list, PI_list, AA_list, P_list)
