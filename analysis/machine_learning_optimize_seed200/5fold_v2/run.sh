...
do
	...
	python3 ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_1condition_p2/fs_network_topn_cVSra top $seed_directory/enet_1condition_p2/classification.topN.result.cVSra.enet.tsv control_ra $i
	...
	python3 ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_3condition/fs_network_topn_cVSra top $seed_directory/enet_3condition/classification.topN.result.cVSra.enet.tsv control_ra $i
	...
	#p2
	#control vs pos
	python3  ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_1condition_p2/fs_network_topn_cVSpos top $seed_directory/enet_1condition_p2/classification.topN.result.cVSpos.enet.tsv control_pos $i

	#control vs neg
	python3  ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_1condition_p2/fs_network_topn_cVSneg top $seed_directory/enet_1condition_p2/classification.topN.result.cVSneg.enet.tsv control_neg $i
	...
	#multi-omics
	#control vs pos
	python3  ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_3condition/fs_network_topn_cVSpos top $seed_directory/enet_3condition/classification.topN.result.cVSpos.enet.tsv control_pos $i

	#control vs neg
	python3  ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_3condition/fs_network_topn_cVSneg top $seed_directory/enet_3condition/classification.topN.result.cVSneg.enet.tsv control_neg $i
	...
	python3 ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_1condition_p2/fs_network_percentage_cVSra percentage $seed_directory/enet_1condition_p2/classification.result.cVSra.enet.tsv control_ra $i
	...
	python3 ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_3condition/fs_network_percentage_cVSra percentage $seed_directory/enet_3condition/classification.result.cVSra.enet.tsv control_ra $i
	...
	#p2
	#control vs pos
	python3  ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_1condition_p2/fs_network_percentage_cVSpos percentage $seed_directory/enet_1condition_p2/classification.result.cVSpos.enet.tsv control_pos $i

	#control vs neg
	python3  ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_1condition_p2/fs_network_percentage_cVSneg percentage $seed_directory/enet_1condition_p2/classification.result.cVSneg.enet.tsv control_neg $i
	...
	#multi-omics
	#control vs pos
	python3  ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_3condition/fs_network_percentage_cVSpos percentage $seed_directory/enet_3condition/classification.result.cVSpos.enet.tsv control_pos $i

	#control vs neg
	python3  ../../../src/machine_learning/classification_5fold.2class.opti.withMCC.py enet_3condition/fs_network_percentage_cVSneg percentage $seed_directory/enet_3condition/classification.result.cVSneg.enet.tsv control_neg $i
